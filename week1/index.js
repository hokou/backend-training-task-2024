...
const totalCost = weightTrainingClassPrice + (yogaClassPrice * 3);
const AlexBudget = sportBudget - totalCost;
console.log(`Alex 買完課程了，他一共剩下 ${AlexBudget} 元`);

// ### 題目四：線稿圖截圖，看圖宣告變數
// 請參考資料夾內 q4.webp 圖片
// 請依照你看到的內容來嘗試設計變數和值（至少 3 個）
const className = "14 堂組合包方案";
...
// 宣告了一個 numberArr1 的陣列，包含數字 5, 10, 15
let numberArr2 = numberArr1;
// 將 numberArr1 的參考賦值給 numberArr2
numberArr2.push(20);
// 將數字 20 推入 numberArr2
numberArr2 = [25, 30, 35];
// 將 numberArr2 賦值為新陣列 [25, 30, 35]
console.log(numberArr1, numberArr2);
// 輸出 numberArr1 和 numberArr2，結果為 [5, 10, 15, 20] 和 [25, 30, 35]
